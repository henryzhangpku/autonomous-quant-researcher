...
Campaign 2 swept put credits only; this is the bearish underwriter — but at 5%-of-width costs
...
OUT_DIR = REPOSITORY_ROOT / ".research" / "sweeps" / "overnight-call-credit-v1"

ENTRY_MINUTES = tuple(range(135, 901, 45)) + (915,)
STRUCTURES = ("spx_call_credit_spread",)
WIDTHS = (20.0, 25.0)
...
def main() -> int:
    ...
    summary = {
        "question": "do CALL CREDIT verticals (selling the upside) work anywhere in the overnight window at measured costs?",
